...
#            axs[num_bank*row+j,1].hist(content_random["miss_ratios"][:,j] - content_random["miss_ratios_core1"][:,j],  bins=bins,alpha = .5, label="random")
    ...
    axs[0,0].legend()
    axs[0,0].set_xticks(bins,minor=True)
    axs[0,0].set_yticks(bins,minor=True)
    ...
    axs[0,1].legend()
    axs[0,1].set_xticks(bins,minor=True)
    axs[0,1].set_yticks(bins,minor=True)
    axs[0,1].grid(which='minor')
    ...
    axs[2,0].legend()
    axs[2,0].set_xticks(bins,minor=True)
    axs[2,0].set_yticks(bins,minor=True)
    axs[2,0].grid(which='minor')
