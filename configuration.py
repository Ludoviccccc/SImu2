...
if __name__ == "__main__":
    ...
    modules +=  [{"type":"diff_ratios_detailled","bank":j,"bins":list(np.linspace(-1,1,41)),"row":row,"core":core} for j in range(num_bank) for row in range((num_addr//16)+1) for core in [0,1]]
