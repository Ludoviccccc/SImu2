...
if __name__ == "__main__":
    ...
    file_imgep_no_ir = lambda k,N: f"history_kNN_{k}_N_{N}_svd_0.pkl"
    files = []
...
#    files +=[{"folder":folder[0],"file":file_imgep_ir(k,N),"name":f"imgep_ir k={k},N={N}","k":k,"N":N,"type":"imgep_ir"} for k in ks]
    files +=[{"folder":folder[1],"file":file_imgep_no_ir(k,N),"name":f"imgep_svd k={k},N={N}","k":k,"N":N,"type":"imgep_no_ir"} for k in ks]
